...
export interface ProductApiInterface {
   ...
   */
  createProductRaw(
    requestParameters: CreateProductOperationRequest,
   ...
   * @memberof ProductApiInterface
   */
  deleteProductByIdRaw(
    requestParameters: DeleteProductByIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ...
  getProductsRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<ProductResponse>>>;
   ...
   * @memberof ProductApiInterface
   */
  updateProductByIdRaw(
    requestParameters: UpdateProductByIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ProductResponse>>;
...
export class ProductApi extends runtime.BaseAPI implements ProductApiInterface {
  ...
  async createProductRaw(
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ProductResponseFromJSON(jsonValue),
    );
  }
  ...
  async deleteProductById(
    ...
    const response = await this.deleteProductByIdRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async getProductById(
    ...
    const response = await this.getProductByIdRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async getProductsRaw(
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(ProductResponseFromJSON),
    );
  }
  ...
  async updateProductById(
    ...
    const response = await this.updateProductByIdRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
